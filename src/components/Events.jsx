    ...
    return <div>
        ...
        <div className="row">
            {quizzes.map(quiz=>{
                ...
                return <div className="col-lg-4">
                    <EventCard id={quiz.id} title={quiz.doc.quizName} date={quiz.doc.date} duration={quiz.doc.timeDuration} start={quiz.doc.startTime} end={quiz.doc.endTime} noOfQues={quiz.doc.noOfQues} disabled="true" />
                </div>        
            })}
        </div>
    </div>
