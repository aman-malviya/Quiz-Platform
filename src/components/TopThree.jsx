    ...
    return (
        <div className="d-flex" style={{'height':'100px', 'width':'150px', 'background':'none', 'alignItems':'flex-end', 'justifyContent':'space-between'}}>
            <div style={{'display':'flex', 'flexDirection':'column', 'justifyContent':'flex-end','alignItems':'center'}}>
                <img alt="Winner" data-bs-toggle="tooltip" data-bs-placement="top" title={props.third} style={{'objectFit':'cover','outline':'2px solid #fff','outlineOffset':'3px'}} src={props.thirdURL} height="40px" width="40px" className="rounded-circle mb-1" />
            ...
            <div style={{'display':'flex', 'flexDirection':'column', 'justifyContent':'flex-end','alignItems':'center'}}>
                <img alt="Winner" data-bs-toggle="tooltip" data-bs-placement="top" title={props.first} style={{'objectFit':'cover','outline':'2px solid #fff','outlineOffset':'3px'}} src={props.firstURL} height="40px" width="40px" className="rounded-circle mb-1" />
            ...
            <div style={{'display':'flex', 'flexDirection':'column', 'justifyContent':'flex-end','alignItems':'center'}}>
                <img alt="Winner" data-bs-toggle="tooltip" data-bs-placement="top" title={props.second} style={{'objectFit':'cover','outline':'2px solid #fff','outlineOffset':'3px'}} src={props.secondURL} height="40px" width="40px" className="rounded-circle mb-1" />
